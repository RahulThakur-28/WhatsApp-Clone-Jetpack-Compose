...
fun CallScreen(navHostController: NavHostController) {
    ...
    var samplecall = listOf(
        call(image = R.drawable.person_22, time = "8:30 am ", "Vikash ", true),
        call(image = R.drawable.person_23, time = "Yesterday , 5:30 am ", "brothr ", true),
        call(image = R.drawable.person_24, time = " Yesterday ,10:00 am", "Aman Yadav Freind ", false),
        call(image = R.drawable.gir, time = "Yesterday , 5:30 am ", " Riya office", true),
        call(image = R.drawable.person_26, time = "20 minutes ago", "salman khan  ", false),
        call(image = R.drawable.boy1, time = "Yesterday , 5:30 am ", "sarukhkhan ", true),
        call(image = R.drawable.carryminati, time = "9:10 pm", "carryminati ", true),
    )
    ...
    Scaffold(
        ...
        bottomBar = { BottomNavigation(navHostController, selectedItem = 3, onClick = {index ->
            when(index){
